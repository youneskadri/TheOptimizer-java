...
// fenetre modification
 javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader ();
                            loader.setLocation(getClass().getResource("ModifBlog.fxml"));
                        try {
                            loader.load();
                        ...
                        ModifBlogController MC = loader.getController();
...
@FXML
  ...
  @FXML
    private void Dashboardclick(javafx.scene.input.MouseEvent event) {
